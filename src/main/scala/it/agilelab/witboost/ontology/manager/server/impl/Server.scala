...
import it.agilelab.witboost.ontology.manager.Resource as GenResource
import it.agilelab.witboost.ontology.manager.api.intepreter.OntologyManagerHandler
...
import it.agilelab.witboost.ontology.manager.system.ApplicationConfiguration.httpPort
...
object Server:
  ...
  val interfaceString: String = Source
    .fromResource("interface-specification.yml")
    .getLines()
